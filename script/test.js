...
$(document).ready(function () {
    ...
    $(".seat-model").click(function () {
        ...
        $("#tab1 .brand-choose-sidebar .brand-summary-label").text($("#tab1 .brand-choose-sidebar").find('[data-brand=' + dataBrand + ']').find(".brand-name").text());
        if (signPlace) {
            currentBrand = ".certus";
            ...
            // $("#tab1 .brand-choose-sidebar .brand-summary-label").text($("#tab1 .brand-choose-sidebar .brand-certus-label .brand-name").text())
            ...
            // $("#tab1 .brand-choose-sidebar .brand-summary-label").text($("#tab1 .brand-choose-sidebar .brand-exima-label .brand-name").text())
        }
    ...
    $("#tab2 .model-type").click(function () {
        ...
        var dataBrand = $(this).attr('data-brand');
        $("#tab2 .brand-choose-sidebar .brand-summary-label").text($("#tab2 .brand-choose-sidebar").find('[data-brand=' + dataBrand + ']').find(".brand-name").text());
