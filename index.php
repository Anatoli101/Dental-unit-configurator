...
<html lang="en">
   <head>
      ...
      <!-- <link rel="stylesheet" href="/konfigurator/css/modal.min.css"> -->
      <link rel="stylesheet" href="https://use.typekit.net/bzk0zrk.css">
      <!--    <link rel="stylesheet" href="/konfigurator/css/main.css">-->
      <link rel="stylesheet" href="/konfigurator/css/main-pawel.css">
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.css" />
   </head>
   <body>
      <div class="main">
         <header>
            <div class="logo-place"><a href=""><img src="/konfigurator/img/makromed.png" alt="image"></a></div>
            ...
            <div class="header-price">
               ...
               <div class="price-block">
                  <p class="price">
                  <p class="price-number" data-total-price="0"><span class="pr">0</span> zł</p>
                  brutto
               </div>
            </div>
            <div class="close-button"><a href=""><img src="/konfigurator/img/close-buttom.png" alt="image"></a></div>
         </header>
         <div class="content">
            <div class="sidebar">
            ...
            <section id="tab1" class="tab-content active visitedTab">
                  ...
                  <div class="brand-sidebar-wrapper">
                     <div class="product-list">
                        <div class="choosen-brand brand-certus-label seat-model " data-brand="certus">
                           ...
                           <p class="brand-price">od 29 000 zł</p>
                           <span class="choosen-brand-sign choose-seat-sign icon-icon_check certus-seat"></span>
                        </div>
                        <div class="choosen-brand brand-exima-label seat-model" data-brand="exima">
                           <p class="brand-name">EXIMA</p>
                           <p class="brand-price">od 22 500 zł</p>
                           <span class="choosen-brand-sign choose-seat-sign icon-icon_check exima-seat"></span>
                        </div>
                     </div>
                  ...
                  <div class="brand-products">
                     <div class="brand-certus">
                        <div class="brand-certus-wrapper">
                           <div class="product-card-top"><img src="/konfigurator/img/certus-logo.png" alt="image"
                              class="logo-img">
                     ...
                     <div class="brand-exima">
                        <div class="brand-exima-wrapper">
                           <div class="product-card-top"><img src="/konfigurator/img/exima-logo@2x.png" alt="image"
                              class="logo-img">
               ...
               <div id="seat-certus" class="seat-one-popup pop-up">
                  <div class="close-pop-up"><img src="/konfigurator/img/close-buttom.png" alt="image"></div>
                  ...
                  <div class="model-card-wrapper">
                     ...
                     <div class="exima-list model-list">
                        <div class="model-card-cover certus">
                           <div class="model-card">
                              <div class="model-over-hidden">
                                 <p class="model-name">CERTUS NEO</p>
                                 <img src="/konfigurator/img/img_panel_komplet_certus_neo@2x.png" alt="image">
                        ...
                        <div class="model-card-cover certus">
                           <div class="model-card">
                              <div class="model-over-hidden">
                                 <p class="model-name">CERTUS MAX</p>
                                 <img src="/konfigurator/img/img_panel_komplet_certus_max@2x.png" alt="image">
                                 <p class="model-description">W standardzie otrzymujesz:</p>
                                 <ul class="model-ul">
                                    <li>W kolorze białym RAL 9016</li>
                                    <li>Fotel Amicus</li>
                        ...
                        <div class="model-card-cover certus">
                           <div class="model-card">
                              <div class="model-over-hidden">
                                 <p class="model-name">CERTUS STANDARD</p>
                                 <img src="/konfigurator/img/img_panel_komplet_certus_standard@2x.png"
                                    alt="image">
                                 <p class="model-description">W standardzie otrzymujesz:</p>
                                 <ul class="model-ul">
                                    <li>W kolorze białym RAL 9016</li>
                     ...
                     <div class="exima-list model-list">
                        <div class="model-card-cover exima">
                           <div class="model-card">
                              <div class="model-over-hidden">
                                 <p class="model-name">EXIMA NEO</p>
                                 <img src="/konfigurator/img/img_panel_komplet_exima_neo@2x.png" alt="image">
                                 <p class="model-description">W standardzie otrzymujesz:</p>
                                 <ul class="model-ul">
                                    <li>W kolorze białym RAL 9016</li>
                                    <li>Fotel Amicus</li>
                        ...
                        <div class="model-card-cover exima">
                           <div class="model-card">
                              <div class="model-over-hidden">
                                 <p class="model-name">EXIMA MAX</p>
                                 <img src="/konfigurator/img/img_panel_komplet_exima_max@2x.png" alt="image">
                                 <p class="model-description">W standardzie otrzymujesz:</p>
                                 <ul class="model-ul">
                                    <li>W kolorze białym RAL 9016</li>
                                    <li>Fotel Amicus</li>
                        ...
                        <div class="model-card-cover exima">
                           <div class="model-card">
                              <div class="model-over-hidden">
                                 <p class="model-name">EXIMA X1G</p>
                                 <img src="/konfigurator/img/img_panel_komplet_exima_standard_x1g@2x.png"
                                    alt="image">
                                 <p class="model-description">W standardzie otrzymujesz:</p>
                                 <ul class="model-ul">
                                    <li>W kolorze białym RAL 9016</li>
                        ...
                        <div class="model-card-cover exima">
                           <div class="model-card">
                              <div class="model-over-hidden">
                                 <p class="model-name">EXIMA X1D</p>
                                 <img src="/konfigurator/img/img_panel_komplet_exima_standard_x1d@2x.png"
                                    alt="image">
                                 <p class="model-description">W standardzie otrzymujesz:</p>
                                 <ul class="model-ul">
                                    <li>W kolorze białym RAL 9016</li>
            ...
            <section id="tab3" class="tab-content hide">
                     ...
                     <div class="seat-color-wrapper">
                        ...
                        <div class="seat-colors">
                           ...
                           <div class="color-kind common-additional">
                              ...
                              <p id="color8" data-color="8" class="color-class choose-the-color no-such-color">
                                 NIEBIESKI<span class="icon-icon_check"></span>
                              </p>
                           </div>
                           <div class="color-kind common-additional">
                        ...
                        <div class="lacquer-type-wrapper certus-neo certus-max certus-standard additional-cost">
                           ...
                           <input class="selected" type="radio" data-price="0" name="radio" id="1" value="value"
                              checked>
                           <label for="1" class="lacquer-type-checkbox tapicerka-color color-white">lakier bloku
                           spluwaczki w kolorze białym</label>
                           <input data-invoice-row="<?php echo $invoice;?>" data-price="300" data-name="TAK"
                              type="radio" name="radio" id="2" value="value">
                           <label for="2" class="lacquer-type-checkbox tapicerka-color color-color">lakier bloku
                           spluwaczki w kolorze tapicerki</label>
                           <div class="color-attantion">
                              <span
                              ...
                              <p class="color-attantion">Dla tego koloru nie ma możliwości doboru lakieru bloku
                                 spluwaczki w kolorze tapicerki
                              </p>
                           </div>
                        </div>
                     </div>
               ...
               <div class="main-content color-content">
                  <div class="color-content-wrapper certus-colors">
                     ...
                     <!--                        <img id="color1" class="color-img img-hidden" src="/konfigurator/seat-color/c-red-w.jpg" alt="image">-->
                     <!--                        <img id="color2" class="color-img img-hidden" src="/konfigurator/seat-color/c-brown-w.jpg" alt="image">-->
                     <!--                        <img id="color3" style="display:block" class="color-img img-hidden" src="/konfigurator/seat-color/c-grey_w.jpg" alt="image">-->
                     <!--                        <img id="color4" class="color-img img-hidden" src="/konfigurator/seat-color/c-light-grey-w.jpg" alt="image">-->
                     <!--                        <img id="color5" class="color-img img-hidden" src="/konfigurator/seat-color/c-fiolet-w.jpg" alt="image">-->
                     <!--                        <img id="color6" class="color-img img-hidden" src="/konfigurator/seat-color/c-blue-w.jpg" alt="image">-->
                     <!--                        <img id="color7" class="color-img img-hidden" src="/konfigurator/seat-color/c-light-blue-w.jpg" alt="image">-->
                     <!--                        <img id="color8" class="color-img img-hidden" src="/konfigurator/seat-color/c-sea-blue-w.jpg" alt="image">-->
                     <!--                        <img id="color9" class="color-img img-hidden" src="/konfigurator/seat-color/c-orange-w.jpg" alt="image">-->
                     <!--                        <img id="color10" class="color-img img-hidden" src="/konfigurator/seat-color/c-yellow-w.jpg" alt="image">-->
                     <!--                        <img id="color11" class="color-img img-hidden" src="/konfigurator/seat-color/c-light-green-w.jpg" alt="image">-->
                     <!--                        <img id="color1_w" class="color-img img-hidden" src="/konfigurator/seat-color/Cer_color_red.jpg" alt="image">-->
                     <!--                        <img id="color3_w" class="color-img img-hidden" src="/konfigurator/seat-color/Cer_color_grey.jpg" alt="image">-->
                     <!--                        <img id="color4_w" class="color-img img-hidden" src="/konfigurator/seat-color/Cer_color_light-grey.jpg" alt="image">-->
                     <!--                        <img id="color5_w" class="color-img img-hidden" src="/konfigurator/seat-color/Cer_color_fiolet.jpg" alt="image">-->
                     <!--                        <img id="color6_w" class="color-img img-hidden" src="/konfigurator/seat-color/Cer_color_granat.jpg" alt="image">-->
                     <!--                        <img id="color7_w" class="color-img img-hidden" src="/konfigurator/seat-color/Cer_color_light_blue.jpg" alt="image">-->
                     <!--                        <img id="color9_w" class="color-img img-hidden" src="/konfigurator/seat-color/Cer_color_orange.jpg" alt="image">-->
                     <!--                        <img id="color10_w" class="color-img img-hidden" src="/konfigurator/seat-color/Cer_color_yellow.jpg" alt="image">-->
                     <!--                    </div>-->
                     ...
                     <div class="certus-brand-color block-colorified-seats certus-neo">
                        <!--                        <img data-color="1" class="color-img" src="/konfigurator/seat-color/certus/" alt="image">-->
                        <img data-color="2" class="color-img additional-cost"
                           src="/konfigurator/seat-color/certus/c-orange-w.jpg" alt="image">
                        <img data-color="3" class="color-img selected additional-cost"
                           src="/konfigurator/seat-color/certus/c-red-w.jpg" alt="image">
                        <img data-color="4" class="color-img additional-cost"
                           src="/konfigurator/seat-color/certus/c-fiolet-w.jpg" alt="image">
                        <img data-color="5" class="color-img additional-cost"
                           src="/konfigurator/seat-color/certus/c-blue-w.jpg" alt="image">
                        <img data-color="6" class="color-img"
                           src="/konfigurator/seat-color/certus/c-light-green-w.jpg" alt="image">
                        <img data-color="7" class="color-img additional-cost"
                           src="/konfigurator/seat-color/certus/c-yellow-w.jpg" alt="image">
                        <img data-color="8" class="color-img additional-cost"
                           src="/konfigurator/seat-color/certus/c-light-blue-w.jpg" alt="image">
                        <img data-color="9" class="color-img additional-cost"
                           src="/konfigurator/seat-color/certus/c-grey_w.jpg" alt="image">
                        <img data-color="10" class="color-img additional-cost"
                           src="/konfigurator/seat-color/certus/c-light-grey-w.jpg" alt="image">
                        <img data-color="11" class="color-img"
                           src="/konfigurator/seat-color/certus/c-sea-blue-w.jpg" alt="image">
                        <img data-color="12" class="color-img" src="/konfigurator/seat-color/certus/c-brown.jpg"
                           alt="image">
                        <img data-color="2" class="color-img common-additional additional-img additional-cost"
                           src="/konfigurator/seat-color/certus-s/c-orange.jpg" alt="image">
                        <img data-color="3"
                           class="color-img common-additional additional-img additional-cost selected"
                           src="/konfigurator/seat-color/certus-s/c-red.jpg" alt="image">
                        <img data-color="4" class="color-img common-additional additional-img additional-cost"
                           src="/konfigurator/seat-color/certus-s/c-fiolet.jpg" alt="image">
                        <img data-color="5" class="color-img common-additional additional-img additional-cost"
                           src="/konfigurator/seat-color/certus-s/c-blue.jpg" alt="image">
                        <img data-color="7" class="color-img common-additional additional-img additional-cost"
                           src="/konfigurator/seat-color/certus-s/c-yellow.jpg" alt="image">
                        <img data-color="8" class="color-img common-additional additional-img additional-cost"
                           src="/konfigurator/seat-color/certus-s/c-light-blue.jpg" alt="image">
                        <img data-color="9" class="color-img common-additional additional-img additional-cost"
                           src="/konfigurator/seat-color/certus-s/c-grey.jpg" alt="image">
                        <img data-color="10" class="color-img common-additional additional-img additional-cost"
                           src="/konfigurator/seat-color/certus-s/c-light-grey.jpg" alt="image">
                     </div>
                     <div class="certus-brand-color block-colorified-seats certus-max">
                        <img class="color-img additional-cost selected"
                           src="/konfigurator/img/img_panel_lekarza_certus_max.png"
                           srcset="/konfigurator/img/img_panel_lekarza_certus_max@2x.png" alt="image">
                     ...
                     <div class="certus-brand-color block-colorified-seats certus-standard">
                        <img class="color-img additional-cost selected"
                           src="/konfigurator/img/img_panel_asysty_certus_standard.png"
                           srcset="/konfigurator/img/img_panel_lekarza_certus_standard@2x.png" alt="image">
                        <img class="color-img common-additional additional-img additional-cost selected"
                           src="/konfigurator/img/img_panel_asysty_certus_standard.png"
                           srcset="/konfigurator/img/img_panel_lekarza_certus_standard@2x.png" alt="image">
                     </div>
                     ...
                     <div class="exima-brand-color block-colorified-seats exima-neo">
                        <!--                        <img data-color="1" class="color-img" src="/konfigurator/seat-color/exima/" alt="image">-->
                        <img data-color="2" class="color-img" src="/konfigurator/seat-color/exima/e-orange.jpg"
                           alt="image">
                        <img data-color="3" class="color-img selected"
                           src="/konfigurator/seat-color/exima/e-red.jpg" alt="image">
                        <img data-color="4" class="color-img" src="/konfigurator/seat-color/exima/e-fiolet.jpg"
                           alt="image">
                        <img data-color="5" class="color-img" src="/konfigurator/seat-color/exima/e-blue.jpg"
                           alt="image">
                        <img data-color="6" class="color-img" src="/konfigurator/seat-color/exima/e-light-green.jpg"
                           alt="image">
                        <img data-color="7" class="color-img" src="/konfigurator/seat-color/exima/e-yellow.jpg"
                           alt="image">
                        <img data-color="8" class="color-img" src="/konfigurator/seat-color/exima/e-light-blue.jpg"
                           alt="image">
                        <img data-color="9" class="color-img" src="/konfigurator/seat-color/exima/e-grey.jpg"
                           alt="image">
                        <img data-color="10" class="color-img" src="/konfigurator/seat-color/exima/e-light-grey.jpg"
                           alt="image">
                        <img data-color="11" class="color-img" src="/konfigurator/seat-color/exima/e-sea-blue.jpg"
                           alt="image">
                        <img data-color="12" class="color-img" src="/konfigurator/seat-color/exima/e-brown.jpg"
                           alt="image">
                     </div>
                     <div class="exima-brand-color block-colorified-seats exima-max">
                        <img class="color-img additional-cost selected"
                           src="/konfigurator/img/img_panel_lekarza_exima_max.png"
                           srcset="/konfigurator/img/img_panel_lekarza_exima_max@2x.png" alt="image">
                        <img class="color-img common-additional additional-img additional-cost selected"
                           src="/konfigurator/img/img_panel_lekarza_exima_max.png"
                           srcset="/konfigurator/img/img_panel_lekarza_exima_max@2x.png" alt="image">
                     </div>
                     <div class="exima-brand-color block-colorified-seats exima-x1d">
                        <img class="color-img additional-cost selected"
                           src="/konfigurator/img/img_panel_lekarza_exima_standard_x1d.png"
                           srcset="/konfigurator/img/img_panel_lekarza_exima_standard_x1d@2x.png" alt="image">
                        <img class="color-img common-additional additional-img additional-cost selected"
                           src="/konfigurator/img/img_panel_lekarza_exima_standard_x1d.png"
                           srcset="/konfigurator/img/img_panel_lekarza_exima_standard_x1d@2x.png" alt="image">
                     </div>
                     <div class="exima-brand-color block-colorified-seats exima-x1g">
                        <img class="color-img additional-cost selected"
                           src="/konfigurator/img/img_panel_asysty_exima_standard_x1g.png"
                           srcset="/konfigurator/img/img_panel_komplet_exima_standard_x1g@2x.png" alt="image">
                        <img class="color-img common-additional additional-img additional-cost selected"
                           src="/konfigurator/img/img_panel_asysty_exima_standard_x1g.png"
                           srcset="/konfigurator/img/img_panel_komplet_exima_standard_x1g@2x.png" alt="image">
                     </div>
                  ...
                  <div class="brand-sidebar-wrapper">
                     <ul class="product-list certus-neo certus-max certus-standard">
                        <li class="choosen-brand lamp-type selected" data-type="lamp1" data-standard="standard">
                           ...
                           <p class="brand-price">Standardowo w zestawie</p>
                     ...
                     <ul class="product-list exima-x1g exima-x1d">
                        <li class="choosen-brand lamp-type" data-type="lamp1">
                           <p class="brand-name">BEZCIENIOWA DIODOWA POLARIS</p>
                           <p class="brand-price">Dopłata: 1 700 zł</p>
                           <span class="choosen-brand-sign icon-icon_check"></span>
                        </li>
                        ...
                        <li class="choosen-brand lamp-type" data-type="lamp3">
                           <p class="brand-name">BEZCIENIOWA DIODOWA POLARIS SENSOMATIC</p>
                           <p class="brand-price">Dopłata: 2 100 zł</p>
                           <span class="choosen-brand-sign icon-icon_check"></span>
                        </li>
                        <li class="choosen-brand lamp-type" data-type="lamp4">
                           <p class="brand-name">BEZCIENIOWA DIODOWA IRIS Z WBUDOWANĄ KAMERĄ</p>
                           <p class="brand-price">Dopłata 22 800 zł</p>
                           <span class="choosen-brand-sign icon-icon_check"></span>
                        </li>
                     </ul>
                     <div class="tab1-summary">
                     ...
                     <div class="lamp-card-cover">
                        <div class="lamp-card">
                           <div class="model-over-hidden">
                              ...
                              <p class="lamp-name"><?php echo $dataName;?></p>
                              <img src="/konfigurator/img/img_lampa_polaris.png" alt="image">
                              ...
                              <p class="lamp-scroll-text"> • Źródło światła - 10 diod LED <br>• Żywotność diod LED
                                 ...
                                 fotopolimeryzacji<br>• Szybkorozłączne uchwyty (możliwość sterylizacji)<br>
                              </p>
                           </div>
                     ...
                     <div class="lamp-card-cover">
                        <div class="lamp-card">
                           <div class="model-over-hidden">
                              ...
                              <p class="lamp-name"><?php echo $dataName;?></p>
                              <img src="/konfigurator/img/img_lampa_halogenowa_isa.png" alt="image">
                              <p class="lamp-description">Opis modelu</p>
                     ...
                     <div class="lamp-card-cover">
                        <div class="lamp-card">
                           <div class="model-over-hidden">
                              ...
                              <p class="lamp-name"><?php echo $dataName;?></p>
                              <img src="/konfigurator/img/img_lampa_polaris_sensomatic.png" alt="image">
                              <p class="lamp-description">Opis modelu</p>
                              <p class="lamp-scroll-text"> • Źródło światła - 10 diod LED <br>• Żywotność diod LED
                                 ok
                                 50.000 godzin pracy<br>• Bardzo niski pobór energii elektrycznej<br>• Nieznaczna
                     ...
                     <div class="lamp-card-cover">
                        <div class="lamp-card">
                           <div class="model-over-hidden">
                              ...
                              <p class="lamp-name"><?php echo $dataName;?></p>
                              <img src="/konfigurator/img/img_lampa_z_kamera.png" alt="image">
                              <p class="lamp-description">Opis modelu</p>
                   ...
                   <div class="brand-choose-sidebar">
                       <div class="brand-sidebar-wrapper">
                           <ul class="product-list certus-neo certus-max certus-standard">
                               <li class="choosen-brand lamp-type selected" data-type="lamp1" data-standard="standard">
                                   <p class="brand-name">BEZCIENIOWA DIODOWA POLARIS</p>
                                   <p class="brand-price">Standardowo w zestawie</p><span class="choosen-brand-sign icon-icon_check"></span>
                               </li>
                               <li class="choosen-brand lamp-type" data-type="lamp2">
                                   <p class="brand-name">BEZCIENIOWA HALOGENOWA ISA</p>
                                   <p class="brand-price">Opcja do wyboru, bez dopłaty</p><span class="choosen-brand-sign icon-icon_check"></span>
                               </li>
                               <li class="choosen-brand lamp-type" data-type="lamp3">
                                   <p class="brand-name">BEZCIENIOWA DIODOWA POLARIS SENSOMATIC</p>
                                   <p class="brand-price">Dopłata: 400 zł</p><span class="choosen-brand-sign icon-icon_check"></span>
                               </li>
                               <li class="choosen-brand lamp-type" data-type="lamp4">
                                   <p class="brand-name">BEZCIENIOWA DIODOWA IRIS Z WBUDOWANĄ KAMERĄ</p>
                                   <p class="brand-price">Dopłata 21 100 zł</p><span class="choosen-brand-sign icon-icon_check"></span>
                               </li>
                           </ul>
                           <ul class="product-list exima-neo exima-max">
                               <li class="choosen-brand lamp-type selected" data-type="lamp1" data-standard="standard">
                           ...
                           <ul class="product-list exima-x1g exima-x1d">
                               <li class="choosen-brand lamp-type" data-type="lamp1">
                                   <p class="brand-name">BEZCIENIOWA DIODOWA POLARIS</p>
                                   <p class="brand-price">Dopłata: 1 700 zł</p><span class="choosen-brand-sign icon-icon_check"></span>
                               </li>
                               <li class="choosen-brand lamp-type selected" data-type="lamp2" data-standard="standard">
                                   <p class="brand-name">BEZCIENIOWA HALOGENOWA ISA</p>
                               ...
                               <li class="choosen-brand lamp-type" data-type="lamp3">
                                   <p class="brand-name">BEZCIENIOWA DIODOWA POLARIS SENSOMATIC</p>
                                   <p class="brand-price">Dopłata: 2 100 zł</p><span class="choosen-brand-sign icon-icon_check"></span>
                               </li>
                               <li class="choosen-brand lamp-type" data-type="lamp4">
                                   <p class="brand-name">BEZCIENIOWA DIODOWA IRIS Z WBUDOWANĄ KAMERĄ</p>
                                   <p class="brand-price">Dopłata 22 800 zł</p><span class="choosen-brand-sign icon-icon_check"></span>
                               </li>
                           </ul>
                           <div class="tab1-summary">
                               <div class="brand-price-summary">
                           ...
                           <div class="lamp-card-cover">
                               <div class="lamp-card">
                                   ...
                                   <p class="lamp-name"><?php echo $dataName;?></p><img
                                           src="/konfigurator/img/img_lampa_polaris.png" alt="image">
                                   <p class="lamp-description">Opis modelu</p>
                                   <p class="lamp-scroll-text"> • Źródło światła - 10 diod LED <br>• Żywotność diod LED ok
                                       50.000 godzin pracy<br>• Bardzo niski pobór energii elektrycznej<br>• Nieznaczna
                                       emisja ciepła<br>• Brak układu chłodzenia eliminuje powstawanie hałasu<br>•
                                       Regulacja intensywności strumienia światław zakresie: od 8.000 do 35.000 lux<br>•
                                       Płynna regulacja temperatury koloru światław zakresie: od 4.200 do 6.000 K<br>•
                                       Index odwzorowania kolorów (CRI): >85<br>• Nie generuje promieni UV - brak
                                       fotopolimeryzacji<br>• Szybkorozłączne uchwyty (możliwość sterylizacji)<br></p>
                                   <div class="lamp-button-div certus-neo certus-max certus-standard">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Standard</span><span class="icon-icon_check"><span class="lamp-additional-price"></span>
                                       </div>
                                       <button data-invoice-row="<?php echo $invoice;?>" data-name="<?php echo $dataName;?>" data-price="0" class="lamp-button lamp-type selected" data-type="lamp1" data-standard="standard"><span class="label-button">WYBRANO</span><span class="lamp-neo icon-icon_check"></span></button>
                                   </div>
                                   <div class="lamp-button-div exima-neo exima-max">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Standard</span><span class="icon-icon_check"><span class="lamp-additional-price"></span>
                                   ...
                                   <div class="lamp-button-div exima-x1g exima-x1d">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Dopłata</span><span class="lamp-additional-price">1 700 zł</span>
                                       </div>
                                       <button data-invoice-row="<?php echo $invoice;?>" data-name="<?php echo $dataName;?>" data-price="1700" class="lamp-button lamp-type" data-type="lamp1"><span class="label-button">WYBIERAM</span><span class="lamp-neo icon-icon_check"></span></button>
                                   </div>
                               </div>
                           </div>
                           <div class="lamp-card-cover">
                               <div class="lamp-card">
                                   <?php $dataName = 'BEZCIENIOWA HALOGENOWA ISA' ?>
                                   <p class="lamp-name"><?php echo $dataName;?></p><img src="/konfigurator/img/img_lampa_halogenowa_isa.png" alt="image">
                                   <p class="lamp-description">Opis modelu</p>
                                   <p class="lamp-scroll-text short-scroll"> • Dwustopniowa regulacja natężenia
                                       światła:17.000 i 22.000 lux <br>• Temperatura koloru światła: 5.000 K<br>• Index
                                   ...
                                   <div class="lamp-button-div certus-neo certus-max certus-standard">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Zmiana bez dopłaty</span><span class="lamp-additional-price"></span>
                                       </div>
                                       <button data-invoice-row="<?php echo $invoice;?>" data-name="<?php echo $dataName;?>" data-price="0" class="lamp-button lamp-type" data-type="lamp2"><span class="label-button">WYBIERAM</span><span class="lamp-neo icon-icon_check"></span></button>
                                   </div>
                                   <div class="lamp-button-div exima-neo exima-max">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Zmiana bez dopłaty</span><span class="lamp-additional-price"></span>
                                   ...
                                   <div class="lamp-button-div exima-x1g exima-x1d">
                                       ...
                                       <button data-invoice-row="<?php echo $invoice;?>" data-name="<?php echo $dataName;?>" data-price="0" class="lamp-button lamp-type standard" data-type="lamp2" data-standard="standard"><span class="label-button">WYBRANO</span><span class="lamp-neo icon-icon_check"></span></button>
                                   </div>
                               </div>
                           </div>
                           <div class="lamp-card-cover">
                               <div class="lamp-card">
                                   <?php $dataName = 'BEZCIENIOWA DIODA POLARIS SENSOMATIC' ?>
                                   <p class="lamp-name"><?php echo $dataName;?></p><img
                                           src="/konfigurator/img/img_lampa_polaris_sensomatic.png" alt="image">
                                   <p class="lamp-description">Opis modelu</p>
                                   <p class="lamp-scroll-text"> • Źródło światła - 10 diod LED <br>• Żywotność diod LED ok
                                       50.000 godzin pracy<br>• Bardzo niski pobór energii elektrycznej<br>• Nieznaczna
                                       emisja ciepła<br>• Brak układu chłodzenia eliminuje powstawanie hałasu<br>•
                                   ...
                                   <div class="lamp-button-div certus-neo certus-max certus-standard">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Dopłata</span><span class="lamp-additional-price">400 zl</span>
                                       </div>
                                       <button data-invoice-row="<?php echo $invoice;?>" data-name="<?php echo $dataName;?>" data-price="400" class="lamp-button lamp-type" data-type="lamp3"><span class="label-button">WYBIERAM</span><span class="lamp-neo icon-icon_check"></span></button>
                                   </div>
                                   <div class="lamp-button-div exima-neo exima-max">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Dopłata</span><span class="lamp-additional-price">400 zl</span>
                                   ...
                                   <div class="lamp-button-div exima-x1g exima-x1d">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Dopłata</span><span class="lamp-additional-price">2 100 zl</span>
                                       </div>
                                       <button data-invoice-row="<?php echo $invoice;?>" data-name="<?php echo $dataName;?>" data-price="2100" class="lamp-button lamp-type" data-type="lamp3"><span class="label-button">WYBIERAM</span><span class="lamp-neo icon-icon_check"></span></button>
                                   </div>
                               </div>
                           </div>
                           <div class="lamp-card-cover">
                               <div class="lamp-card">
                                   <?php $dataName = 'BEZCIENIOWA DIODOWA IRIS Z WBUDOWANĄ KAMERĄ' ?>
                                   <p class="lamp-name"><?php echo $dataName;?></p><img
                                           src="/konfigurator/img/img_lampa_z_kamera.png" alt="image">
                                   <p class="lamp-description">Opis modelu</p>
                                   <p class="lamp-scroll-text"> • Źródło światła - 8 diod LED o bardzo niskim
                                   ...
                                   <div class="lamp-button-div certus-neo certus-max certus-standard">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Dopłata</span><span class="lamp-additional-price">21 000 zl</span>
                                       </div>
                                       <button data-invoice-row="<?php echo $invoice;?>" data-name="<?php echo $dataName;?>" data-price="21000" data-type="lamp4" class="lamp-button lamp-type"><span class="label-button">WYBIERAM</span><span class="lamp-neo icon-icon_check"></span></button>
                                   </div>
                                   <div class="lamp-button-div exima-neo exima-max">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Dopłata</span><span class="lamp-additional-price">21 000 zl</span>
                                   ...
                                   <div class="lamp-button-div exima-x1g exima-x1d">
                                       <div class="lamp-button-row">
                                           <span class="lamp-price lamp-type">Dopłata</span><span class="lamp-additional-price">22 800 zl</span>
                                       </div>
                                       <button data-invoice-row="<?php echo $invoice;?>" data-name="<?php echo $dataName;?>" data-price="22800" data-type="lamp4" class="lamp-button lamp-type"><span class="label-button">WYBIERAM</span><span class="lamp-neo icon-icon_check"></span></button>
                                   </div>
                               </div>
                           </div>
                       </div>
                  ...
                  <div class="doctor-panel-wrapper">
                     ...
                     <div class="doctor-panel-top">
                        <img class="doctor-panel-img small-panel common certus-neo" alt="img"
                           src="/konfigurator/img/img_panel_lekarza_certus_neo.png"
                           srcset="/konfigurator/img/img_panel_lekarza_certus_neo@2x.png">
                        <img class="doctor-panel-img small-panel common certus-max" alt="img"
                           src="/konfigurator/img/img_panel_lekarza_certus_max.png"
                           srcset="/konfigurator/img/img_panel_lekarza_certus_max@2x.png">
                        <img class="doctor-panel-img small-panel common certus-standard" alt="img"
                           src="/konfigurator/img/img_panel_lekarza_certus_standard.png"
                           srcset="/konfigurator/img/img_panel_lekarza_certus_standard@2x.png">
                        <img class="doctor-panel-img small-panel common exima-neo" alt="img"
                           src="/konfigurator/img/img_panel_lekarza_exima_neo.png"
                           srcset="/konfigurator/img/img_panel_lekarza_exima_neo@2x.png">
                        <img class="doctor-panel-img small-panel common exima-max" alt="img"
                           src="/konfigurator/img/img_panel_lekarza_exima_max.png"
                           srcset="/konfigurator/img/img_panel_lekarza_exima_max@2x.png">
                        <img class="doctor-panel-img small-panel common exima-x1g" alt="img"
                           src="/konfigurator/img/img_panel_lekarza_exima_standard_x1g@2x.png"
                           srcset="/konfigurator/img/img_panel_komplet_exima_standard_x1g@2x.png">
                        <img class="doctor-panel-img small-panel common exima-x1d" alt="img"
                           src="/konfigurator/img/img_panel_lekarza_exima_standard_x1d.png"
                           srcset="/konfigurator/img/img_panel_lekarza_exima_standard_x1d@2x.png">
                     </div>
                     <div class="doctor-panel-row">
                        <div class="panel-card-cover d-panel1">
                           <span class="icon-icon_check"></span>
                           <div class="doctor-panel-card">
                              <span class="start-here-img icon-icon_start_here"></span>
                        ...
                        <div class="tab1-row">
                           ...
                           <div class="tab1-row-card">
                              ...
                              <p class="tab1-card-description"><span class="bold-text">Dmuchawka
                                 3-funkcyjna</span>(zamiana ze standardowej DCI na panelu lekarza)
                              </p>
                              ...
                              <div class="checkbox-card turbina--light statement-1">
                                 ...
                                 <div class="panel-price">
                                    ...
                                    <div class="info-icon-block"
                                       ...
                                       <img class="info-icon" src="/konfigurator/img/info.png" alt="image">
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="statement statement-<?php echo $j;?>">
                                 ...
                                 <p class="tur-attention-icon attention-p">Do tego modelu turbiny dołączana jest
                                    szybkozłączka PTL-CL-LED w cenie <span class="turbina-bold-price"
                                       style="color: #50515C;">830 zł</span>
                                 </p>
                              </div>
                              <?php endfor ;?>
                           </div>
                              ...
                              <div class="statement statement-<?php echo $j;?>">
                                 ...
                                 <p class="tur-attention-icon attention-p">Do tego modelu turbiny dołączana jest
                                    szybkozłączka FM-CL-M4-T w cenie <span class="turbina-bold-price"
                                       style="color: #50515C;">544 zł</span>
                                 </p>
                              </div>
                              <?php endfor ;?>
                           </div>
                              ...
                              <div data-tab="el-light" class="tab-content-internal-1 tab-as-trigger el-light-on">
                                 <div class="checkbox-card">
                                    ...
                                    <p class="panel-checkbox-p">Tytanowy mikrosilnik elektryczny z funkcją ENDO,
                                       z Multipadem, z podświetleniem LED
                                    </p>
                                    <div class="panel-price">
                                    ...
                                    <div class="checkbox-card">
                                       ...
                                       <div class="panel-price">
                                          ...
                                          <div class="info-icon-block"
                                             ...
                                             <img class="info-icon" src="/konfigurator/img/info.png"
                                                alt="image">
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="checkbox-card">
                                       ...
                                       <div class="panel-price">
                                          ...
                                          <div class="info-icon-block"
                                             ...
                                             class="info-icon" src="/konfigurator/img/info.png"
                                             alt="image"></div>
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div id="without-light" class="checkbox-card">
                                       <div class="panel-checkbox-place"><input
                                          ...
                                          <label for="tab<?php echo $i;?>-smax-m-25"
                                             class="panel-checkbox-div"> S-Max M 25 </label>
                                       </div>
                                 ...
                                 <div id="with-light" class="mikro-katnica-light choose-to-continue tab-last">
                                    <div id="with-light" class="checkbox-card">
                                       ...
                                       <p class="panel-checkbox-p">Kątnica tytanowa na mikrosilnik z
                                          przełożeniem 1:1, pojedynczy aerosol
                                       </p>
                                       <div class="panel-price">
                                    ...
                                    <div id="with-light" class="checkbox-card">
                                       ...
                                       <p class="panel-checkbox-p">Kątnica tytanowa na mikrosilnik z
                                          przełożeniem 1:5, pojedynczy aerosol
                                       </p>
                                       <div class="panel-price">
                              ...
                              <div class="checkbox-card">
                                 ...
                                 <div class="panel-price">
                                    ...
                                    <div class="info-icon-block"
                                       ...
                                       class="info-icon" src="/konfigurator/img/info.png" alt="image">
                                    </div>
                                 </div>
                              </div>
                              <div class="checkbox-card">
                        ...
                        <div id="wolny-rekaw" data-tab="tab-rekaw" class="main-panel-wrapper tab-rekaw">
                           ...
                           <div class="attention-block-wrapper certus-standard exima-x1g exima-x1d">
                              <div class="attention-wrapper">
                                 <span class="icon-icon_exclamation"></span>
                                 <p>W unicie <span class="data-brand certus-standard">CERTUS STANDARD</span><span
                                    ...
                                    jest dodatkowo płatny, jego cena to 350 zł.
                                 </p>
                              </div>
                     ...
                     <div class="tab1-summary">
                        ...
                        <div class="step-1">
                           <p class="info common certus-max certus-standard exima-max exima-x1g exima-x1d">Kliknij
                              "Pomiń" jeśli nie chcesz uwzględniać paneliku asysty w swoim zestawie.
                           </p>
                           <div class="prev-step-button">
                              <button class="step-back-button">WRÓĆ</button>
                              <span class="icon-icon_arrow_left"></span>
                  ...
                  <div class="assyst-content">
                     <div class="step-1 assyst-content-internal">
                        ...
                        <div class="assyst-content-wrapper common certus-neo">
                           ...
                           <img src="/konfigurator/img/img_panel_asysty_certus_neo.png"
                              srcset="/konfigurator/img/img_panel_asysty_certus_neo@2x.png" alt="img">
                        ...
                        <div class="assyst-content-wrapper common certus-max">
                           <span class="label-top uppercase">panel asysty - 4 uchwyty</span>
                           <img src="/konfigurator/img/img_panel_asysty_certus_max.png"
                              srcset="/konfigurator/img/img_panel_asysty_certus_max@2x.png" alt="img">
                        ...
                        <div class="assyst-content-wrapper common certus-standard">
                           ...
                           <img src="/konfigurator/img/img_panel_asysty_certus_standard.png"
                              srcset="/konfigurator/img/img_panel_asysty_certus_standard_numbers@2x.png"
                              alt="img">
                           <div class="label-bottom"><span class="label-internal">Dopłata</span><span
                        ...
                        <div class="assyst-content-wrapper common exima-neo">
                           <span class="label-top uppercase">panel asysty - 4 uchwyty</span>
                           <img src="/konfigurator/img/img_panel_asysty_exima_neo.png"
                              srcset="/konfigurator/img/img_panel_asysty_exima_neo@2x.png" alt="img">
                        ...
                        <div class="assyst-content-wrapper common exima-max">
                           <span class="label-top uppercase">panel asysty - 3 uchwyty</span>
                           <img src="/konfigurator/img/img_panel_asysty_exima_max.png"
                              srcset="/konfigurator/img/img_panel_asysty_exima_max@2x.png" alt="img">
                           <div class="label-bottom"><span class="label-internal">Dopłata</span><span
                              class="price"> 600 zł</span></div>
                           <button data-invoice-row="<?php echo $invoice;?>"
                              class="assyst-main-button assyst-place" data-price="600"
                        ...
                        <div class="assyst-content-wrapper common exima-x1g">
                           <span class="label-top uppercase">panel asysty - 3 uchwyty</span>
                           <img src="/konfigurator/img/img_panel_asysty_exima_standard_x1g.png"
                              srcset="/konfigurator/img/img_panel_asysty_exima_standard_x1g@2x.png" alt="img">
                           <div class="label-bottom"><span class="label-internal">Dopłata</span><span
                              class="price"> 600 zł</span></div>
                           <button data-invoice-row="<?php echo $invoice;?>"
                              class="assyst-main-button assyst-place" data-price="600"
                        ...
                        <div class="assyst-content-wrapper common exima-x1d">
                           <span class="label-top uppercase">panel asysty - 3 uchwyty</span>
                           <img src="/konfigurator/img/img_panel_asysty_exima_standard_x1d.png"
                              srcset="/konfigurator/img/img_panel_asysty_exima_standard_x1d@2x.png" alt="img">
                           <div class="label-bottom"><span class="label-internal">Dopłata</span><span
                              class="price"> 600 zł</span></div>
                           <button data-invoice-row="<?php echo $invoice;?>"
                              class="assyst-main-button assyst-place" data-price="600"
                     ...
                     <div class="step-2 assyst-content-internal">
                        <div class="assyst-step2-content">
                           <img class="small-panel common certus-neo"
                              src="/konfigurator/img/img_panel_asysty_certus_neo.png"
                              srcset="/konfigurator/img/img_panel_asysty_certus_neo@2x.png" alt="img">
                           <img class="small-panel common certus-max"
                              src="/konfigurator/img/img_panel_asysty_certus_max.png"
                              srcset="/konfigurator/img/img_panel_asysty_certus_max@2x.png" alt="img">
                           ...
                           <img class="small-panel common exima-neo"
                              src="/konfigurator/img/img_panel_asysty_exima_neo.png"
                              srcset="/konfigurator/img/img_panel_asysty_exima_neo@2x.png" alt="img">
                           <img class="small-panel common exima-max"
                              src="/konfigurator/img/img_panel_asysty_exima_max.png"
                              srcset="/konfigurator/img/img_panel_asysty_exima_max@2x.png" alt="img">
                           <img class="small-panel common exima-x1g"
                              src="/konfigurator/img/img_panel_asysty_exima_standard_x1g.png"
                              srcset="/konfigurator/img/img_panel_asysty_exima_standard_x1g@2x.png" alt="img">
                           <img class="small-panel common exima-x1d"
                              src="/konfigurator/img/img_panel_asysty_exima_standard_x1d.png"
                              srcset="/konfigurator/img/img_panel_asysty_exima_standard_x1d@2x.png" alt="img">
                           ...
                           <div id="assyst-strykawko-tab-<?php echo $i; ?>"
                              ...
                              <div class="checkbox-card">
                                 ...
                                 <p class="panel-checkbox-p"><span class="bold-text">Dmuchawka 6-funkcyjna
                                    zpodgrzewaniem i światłem </span>
                                 </p>
                                 <div class="panel-price">
                  ...
                  <div class="brand-sidebar-wrapper">
                     <div class="product-list">
                        <div id="fotel-additional" class="choosen-brand tab7-mikro-tab additional-product-tab1"
                           ...
                           <p class="brand-price"></p>
                           <span class="choosen-brand-sign fotel-span"></span>
                        </div>
                        ...
                        <div id="kamery-additional" class="choosen-brand tab7-mikro-tab"
                           ...
                           <p class="brand-price"></p>
                           <span class="choosen-brand-sign "></span>
                        </div>
                        ...
                        <div id="kompressor-additional" class="choosen-brand tab7-mikro-tab additional-product-tab2"
                           ...
                           <p class="brand-price"></p>
                           <span class="choosen-brand-sign kompresor-span"></span>
                        </div>
               ...
               <div class="main-content model-content">
                  <div class="model-card-wrapper">
                     ...
                     <div id="fotel-additional" class="seat-and-additional additional-tab active">
                        <div class="model-card-cover">
                           <div class="model-card final-seat seat1">
                              <p class="model-name">ROGAL</p>
                              <img src="/konfigurator/img/rogal.jpg" alt="image">
                              ...
                              <div class="additional-row-amount">
                                 <p class="amount-additional">Liczba sztuk:</p>
                                 <input type="number" step="1" class="additional-number-input" placeholder="0"
                                    value="1" />
                              </div>
                        ...
                        <div class="model-card-cover">
                           <div class="model-card final-seat seat2">
                              <p class="model-name">SIODŁO</p>
                              <img src="/konfigurator/img/siodlo.jpg" alt="image">
                              <p class="fotel-description fotel-description-2" placeholder="69">Fotelik lekarski z
                                 ergonomicznym siedziskiem
                              </p>
                              <p class="additional-product-price">900 zł</p>
                              <div class="additional-row-amount">
                                 <p class="amount-additional">Liczba sztuk:</p>
                                 <input data-type="" type="number" step="1"
                                    class="additional-number-input additO" placeholder="0" value="1" />
                              </div>
                              <div class="dodatki-button">
                     ...
                     <div id="kamery-additional" class="seat-and-additional additional-tab">
                        <div class="model-card-cover">
                           <div class="model-card final-seat seat1">
                              <p class="model-name">Neovo X-17</p>
                              <img src="/konfigurator/img/img_NEOVO X-17@2x.png" alt="image">
                              <p class="fotel-description fotel-description-1 ">Do Zmiany</p>
                              <p class="additional-product-price">100 zł</p>
                              <div class="additional-row-amount">
                                 <p class="amount-additional">Liczba sztuk:</p>
                                 <input data-type="" type="number" step="1" class="additional-number-input"
                        ...
                        <div class="model-card-cover">
                           <div class="model-card final-seat seat2">
                              <p class="model-name">ADVANCE CAM</p>
                              <img src="/konfigurator/img/img_ADVANCE CAM@2x.png" alt="image">
                     ...
                     <div id="kompressor-additional" class="additional-product-tab3 kompressors-tab additional-tab">
                        <div class="fotel-card-cover model-card-cover">
                           <div class="model-card">
                              <p class="model-name">DK-50Z-10</p>
                              <img src="/konfigurator/img/img_DK-50Z-10.png" alt="image">
                        ...
                        <div class="fotel-card-cover model-card-cover">
                           <div class="model-card">
                              <p class="model-name">DÜRR TORNADO 70</p>
                              <img src="/konfigurator/img/img_DÜRR-tornado.png" alt="image">
                              <p class="kompressor-description ">Kompresor bezolejowy w obudowie wygłuszającej</p>
                        ...
                        <div class="model-card-cover">
                           <div class="model-card final-seat seat2">
                              ...
                              <p class="fotel-description fotel-description-2" placeholder="69">Ssak chirurgiczny
                                 z separatorem amalgamatu z instalacją (Cattani - Włochy)
                              </p>
            ...
            <section id="tab8" class="tab-content hide">
               <div class="tab-summary">
                  <div class="for-print-section" style="font-family: 'zeitung-micro',sans-serif;">
                     <!--                    <p class="summary-top-title" style="color:#32333B;font-size:20px;line-height:30px;font-weight:700;margin:40px 0 0 50px;"><b>Konfiguracja unitu stomatologicznego</b></p>-->
                     <div id="invoice">
                        <p class="summary-top-title"
                           style="color:#32333B;font-size:20px;line-height:30px;font-weight:700;margin:40px 0 0 0;">
                           <b>Konfiguracja unitu stomatologicznego</b>
                        </p>
                        <table class="table table-striped">
                           <thead>
                              <tr class='warning' style="padding-bottom:30px">
                                 <th style="width: 35%; height:20px; font-weight:bold;">Produkt</th>
                                 <th style="width: 45%; height:20px; font-weight:bold;">Wersja</th>
                                 <th style="width: 20%; height:20px; font-weight:bold;">Cena</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr id="invoice-row-1" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel"></td>
                                 <td style="width: 45%; padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                                 <td style="width: 20%; padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="price-label"><span class="pr" data-default="0"></span> zł</td>
                              </tr>
                              <tr id="invoice-row-2" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Kolor unitu"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="Biały RAL 9016"></span></td>
                                 <td style="width: 20%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="price-label"><span class="pr">0</span> zł</td>
                              </tr>
                              <tr id="invoice-row-3" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Kolor spluwaczki w kolorze tapicerki"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-4" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Lampa"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-5" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 1)">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                              ...
                              <tr id="invoice-row-6" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 2)">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                              ...
                              <tr id="invoice-row-s52" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 2) szybkozłączka"></td>
                                 <td style="width: 45%" class="version"><span class="counter"
                                    data-default=""></span><span class="label" data-default="NIE"></span>
                                 </td>
                                 <td style="width: 20%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="price-label"><span class="pr" data-default="0"></span> zł</td>
                              </tr>
                              <tr id="invoice-row-k52" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 2) kątnica"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-p52" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 2) prostnica"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-7" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 3)">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                              ...
                              <tr id="invoice-row-s53" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 3) szybkozłączka"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-k53" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 3) kątnica"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-p53" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 3) prostnica"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-8" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 4)">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                              ...
                              <tr id="invoice-row-s54" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 4) szybkozłączka"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-k54" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 4) kątnica"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-p54" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 4) prostnica"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-9" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 5)">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                              ...
                              <tr id="invoice-row-s55" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 5) szybkozłączka"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-k55" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 5) kątnica"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-p55" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel doktora (rękaw 5) prostnica"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-10" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel asysty"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-11" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel asysty (miejsce 1)">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                              ...
                              <tr id="invoice-row-s61" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel asysty (miejsce 1) szybkozłączka"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-12" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel asysty (miejsce 2)">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                              ...
                              <tr id="invoice-row-s62" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel asysty (miejsce 2) szybkozłączka"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-13" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Panel asysty (mioejsce 3)">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default=""></span><span
                                    class="label" data-default="NIE"></span>
                              ...
                              <tr id="invoice-row-711" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Dodatek: Fotelik lekarski">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default="1"></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                                 <td style="width: 20%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="price-label"><span class="pr" data-default="0"></span> zł</td>
                              ...
                              <tr id="invoice-row-721" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Dodatek: Monitor medyczny">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default="1"></span><span
                                    class="label" data-default="NIE"></span>
                              ...
                              <tr id="invoice-row-722" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Dodatek: Kamera wewnątrzustna"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default="1"></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-731" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Dodatek: Kompresor"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default="1"></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-741" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Dodatek: Ssak chirurgiczny"></td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default="1"></span><span
                                    class="label" data-default="NIE"></span>
                                 </td>
                              ...
                              <tr id="invoice-row-744" class="invoice-row hidden">
                                 <td style="width: 35%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="product" data-default="Dodatek: Pompa ssaków">
                                 </td>
                                 <td style="width: 45%;padding:10px 0; line-height:30px;border-bottom:1px solid #E4E5ED"
                                    class="version"><span class="counter" data-default="1"></span><span
                                    class="label" data-default="NIE"></span>
                           ...
                           <tfoot>
                              <tr style="color: #32333B;">
                                 <td style="height:40px; line-height: 40px; font-size: 11px; width: 35%">
                                    <b>Podane ceny są cenami brutto.</b>
                                 </td>
                                 <td style="height:40px; line-height: 40px;width:45%"></td>
                                 <td class="pdf-price"
                                    style="height:40px;font-size: 13px; line-height: 40px; text-align:end;font-weight:bold; width: 20%">
                                    Suma: <span class="total-price-invoice" data-default="0"></span> zł
                                 </td>
                              </tr>
                           </tfoot>
                        </table>
                                 ...
                                 <tbody>
                                    <tr style="">
                                       ...
                                       <td
                                          ...
                                          <b>Unity stomatologiczne:</b>
                                       </td>
                                    </tr>
                                    <tr style="">
                                       <td style="width:40% ;height:40px">
                                          <img src="../konfigurator/img/makromed.png" style="width:101px"
                                             alt="image">
                                       </td>
                                       <td style="width: 60%;height:40px ">
                                          <img src="../konfigurator/img/exima-logo.png" alt="image"
                                             style="width:72px">
                                          <img src="../konfigurator/img/certus-logo.png"
                        ...
                        <div class="none-obj">
                            <div class="footer-pdf">
                                <table style="width:100%;margin:40px 0 0 50px;">
                                    ...
                                    <tbody>
                                    <tr style="">
                                        <td style="width:40%;   font-weight:700;    font-size:9px;color:#32333B;    height:30px"><b>Producent:</b></td>
                                        <td style="width:60%;  font-weight:700;    font-size:9px;color:#32333B;    height:30px"><b>Unity stomatologiczne:</b></td>
                                    </tr>
                                    <tr style="">
                                        <td style="width:40% ;height:40px">
                                            <img src="/konfigurator/img/makromed.png" style="width:101px" alt="image">
                                        </td>
                                        <td style="width: 60%;height:40px ">
                                            <img src="/konfigurator/img/exima-logo.png" alt="image" style="width:72px">
                                            <img src="/konfigurator/img/certus-logo.png" style="width:77px;padding-right:20px;" alt="image">
                                        </td>
                                    </tr>
                                    <tr style="">
                                        <td style="width:40%;font-size:7px;line-height:12px">
                                        ...
                                        <td style="width: 60%;font-size:7px;line-height:12px;text-align:left;margin-left:-100px">
                                            Niniejsza wycena nie jest ofertą w rozumieniu kodeksu cywilnego.<br>
                                            Zastrzegamy sobie prawo do zmiany obecnych konfiguracji.<br>
                                            Prosimy o przesłanie otrzymanej wyceny do weryfikacji.<br> <b style="width:70%;  font-weight:700;    font-size:9px;color:#32333B; line-height:35px">www.makromed.com.pl</b>
                                        </td>
                                    <tr style="">
                                    </tbody>
                                    <tfoot></tfoot>
                  ...
                  <div class="tab8-buttons">
                     ...
                     <form action="/konfigurator/print.php" method="post" target="_blank">
                        <button class="print-pdf-button">POBIERZ PDF</button>
                        <textarea name="print" id="textarea-for-print"></textarea>
                     </form>
                     <a href="#ex1" rel="modal:open" class="pdf-sender">WYSLIJ EMAIL</a>
                  </div>
               </div>
      ...
      <script src="/konfigurator/script/script.js"></script>
      <script src="/konfigurator/script/form-alert.js"></script>
      <script>
         $(function () {
